# Example from https://www.studytonight.com/tkinter/calculator-application-using-tkinter
from tkinter import *

win = Tk()  # This is to create a basic window
# win.geometry("624x324")  # this is for the size of the window
...
input_frame = Frame(win, height=50, bd=0, highlightbackground="black", highlightcolor="black",
...
input_field = Entry(input_frame, font=('arial', 16, 'bold'), textvariable=input_text, width=42, bg="#eee", bd=0,
                    justify=RIGHT)
